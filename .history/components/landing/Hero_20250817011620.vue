<template>
  <section
    class="relative w-screen min-h-screen overflow-hidden bg-gradient-to-b from-[#9dcd5a]/10 to-transparent dark:from-[#9dcd5a]/5 dark:bg-gray-900/90 transition-colors duration-500">
      ...
      <div class="w-full max-w-4xl mx-auto text-center space-y-8">
        ...
        <div class="w-screen -mx-4 sm:-mx-6 lg:-mx-8 mt-6 mb-8 transition-all duration-1000 transform delay-600"
          ...
          <div class="overflow-hidden">
            <div class="animate-scroll-categories flex whitespace-nowrap py-3">
...
import driedfish from "@/assets/img/farm2door-beef.png"
