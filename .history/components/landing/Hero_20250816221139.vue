    ...
    <div
      ...
      <div class="w-full max-w-4xl mx-auto text-center space-y-8">
        ...
        <div class="space-y-4 transition-all duration-1000 transform"
          ...
          <h2
            class="font-['Barlow_Condensed'] text-3xl sm:text-4xl md:text-5xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white">
            Authentic Nigerian heritage foods from trusted farms delivered fresh to your doorstep
          </h2>
        </div>

        <!-- Product Gallery -->
        <div class="relative w-full h-56 sm:h-64 md:h-72 mt-8 mb-12 transition-all duration-1000 transform delay-300"
          :class="isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'">
          <!-- Main Featured Image -->
          <div
            class="absolute inset-0 rounded-full overflow-hidden shadow-xl z-20 animate-tilt-scale border-4 border-white/20">
