  ...
  <section
    ...
    <div
      ...
      <div class="w-full max-w-4xl mx-auto text-center space-y-8">
        ...
        <!-- Product Gallery -->
        <div
          class="relative w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto h-48 sm:h-52 md:h-56 mt-8 mb-12 transition-all duration-1000 transform delay-300"
          :class="isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'">
          <!-- Main Featured Image -->
          <div
            class="absolute inset-4 rounded-full overflow-hidden shadow-xl z-20 animate-smooth-morph border-4 border-white/20">
