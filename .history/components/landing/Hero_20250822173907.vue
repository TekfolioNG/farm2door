        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div class="order-2 lg:order-1 space-y-8">
            ...
            <div class="space-y-6 transition-all duration-1000 transform"
              ...
              <p class="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 font-light leading-relaxed max-w-lg">
            ...
            <div class="space-y-4">
              <div v-for="(badge, index) in trustBadges" :key="badge.id"
                ...
                <div class="flex items-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-100 dark:border-gray-700">
            ...
            <div class="pt-4 transition-all duration-1000 transform delay-1000"
              ...
              <button @click="enterFarmMarket"
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out" />
              </button>
            </div>
          </div>
          ...
          <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div class="relative w-80 h-80 sm:w-96 sm:h-96 md:w-[28rem] md:h-[28rem] transition-all duration-1000 transform"
              :class="isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'">
              ...
              <div class="relative w-full h-full transition-all duration-1000 transform hover:scale-105">
                ...
                <div class="absolute inset-0 bg-gradient-radial from-[#9dcd5a]/20 via-transparent to-transparent blur-xl -z-10 animate-pulse-glow" />
              </div>
              ...
              <div class="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-br from-[#9dcd5a] to-[#7ba54a] rounded-full opacity-80 animate-float" />
              <div class="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-br from-[#b8d975] to-[#9dcd5a] rounded-full opacity-60 animate-float-delayed" />
            </div>
          </div>
        </div>
      </div>
...
import { ShieldCheck, Truck, Utensils, Award, Clock, Leaf, Users, Heart } from 'lucide-vue-next'
...
import poultry from "@/assets/img/farm-2dooor-veggies.png"
