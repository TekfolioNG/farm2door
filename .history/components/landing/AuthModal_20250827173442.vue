<template>
    <div>
        ...
        <div v-if="showAuthModal"
            class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-8 bg-black/50 backdrop-blur-sm transition-opacity duration-300"
            @click.self="closeModal">
            <!-- Modal Container -->
            <div
                class="relative w-full max-w-md mx-4 my-8 sm:my-12 md:my-16 bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 scale-100 opacity-100">
                <!-- Close Button -->
                ...
                <!-- Logo -->
                <div class="flex justify-center pt-8 px-8">
                ...
                <div class="flex border-b border-gray-200 dark:border-gray-700 mt-6">
                    <button @click="activeTab = 'login'" class="flex-1 py-4 text-center font-medium transition-colors"
                        :class="activeTab === 'login'
                            ? 'text-[#7ba54a] border-b-2 border-[#7ba54a]'
                            : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'">
                        Login
                    </button>
                    <button @click="activeTab = 'signup'" class="flex-1 py-4 text-center font-medium transition-colors"
                ...
                <div class="px-8 py-6">
                    ...
                    <form v-if="activeTab === 'login'" @submit.prevent="handleLogin" class="space-y-4">
                        <div>
                            ...
                            <input id="login-email" v-model="loginForm.email" type="email" required
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#7ba54a] focus:border-transparent dark:bg-gray-700 dark:text-white transition-colors"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-sm text-[#7ba54a] hover:underline">Forgot password?</a>
                        </div>

                        <button type="submit"
                            class="w-full py-2.5 px-4 bg-[#7ba54a] hover:bg-[#6a9342] text-white font-medium rounded-lg transition-colors duration-200">
                            Log In
                        </button>
                    </form>
                    ...
                    <form v-if="activeTab === 'signup'" @submit.prevent="handleSignup" class="space-y-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="terms" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                                I agree to the <a href="#" class="text-[#7ba54a] hover:underline">Terms of Service</a>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button @click="socialLogin('google')"
                            class="flex items-center justify-center py-2.5 px-4 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                        ...
                        <button @click="socialLogin('microsoft')"
                            class="flex items-center justify-center py-2.5 px-4 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                            <svg class="w-5 h-5 mr-2" viewBox="0 0 23 23" fill="none"
                ...
                <!-- Footer Links -->
                <div class="px-8 py-4 bg-gray-50 dark:bg-gray-700/50 text-center">
