<template>
  <section class="min-h-screen bg-zinc-900 relative overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
      ...
      <!-- Logo & Tagline -->
      <header class="text-center mb-16 transition-all duration-2000"
      ...
      <div class="relative w-full max-w-6xl h-96 hidden md:block">
