...
const handleSignup = (): void => {
    if (!props.loading && isSignupValid.value) {
        ...
        console.log('Emitting signup data:', { ...signupForm }) // Add this line
...
/* Add these CSS classes to your AuthModal component or global CSS */

/* Make all buttons and clickable elements show pointer cursor */
.btn,
button,
[role="button"],
.clickable,
