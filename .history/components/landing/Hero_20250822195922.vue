<template>
  <section
    ...
    <div class="relative z-10 w-full min-h-screen flex items-center px-4 sm:px-6 lg:px-12 py-16 pt-24">
      <div class="w-full max-w-7xl mx-auto">
        <!-- Two Column Layout -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4 items-center">

          <!-- Left Column - Content -->
          <div class="order-2 lg:order-1 space-y-6 mt-8 lg:mt-16 lg:pr-8">
            <!-- Main Headline -->
        ...
        <div class="w-full flex justify-center mt-4 lg:mt-4 transition-all duration-1000 transform delay-1000"
...
import { Award, ChefHat, Clock, Globe, Leaf, Users, Utensils } from 'lucide-vue-next'
...
const trustBadges = ref<TrustBadge[]>([
  ...
  {
    id: 7,
    text: "Nigerian diaspora's preferred choice",
    icon: Globe
  }
])
