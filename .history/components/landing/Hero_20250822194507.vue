<template>
  <section
    ...
    <div class="relative z-10 w-full min-h-screen flex items-center px-6 sm:px-8 lg:px-12 py-16 pt-24">
      <div class="w-full max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          <div class="order-2 lg:order-1 space-y-8">
            ...
            <div class="space-y-6 transition-all duration-1000 transform"
              ...
              <p
                ...
                Premium, locally sourced ingredients from trusted farms, delivered straight to your doorstep,
                <strong><em>
                    fast
                    and fresh.
                  </em></strong>
            ...
            <div class="h-56 md:h-64 relative mt-8 mb-12">
          ...
          <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div
              class="relative w-64 h-64 sm:w-80 sm:h-80 md:w-[22rem] md:h-[22rem] transition-all duration-1000 transform"
              :class="isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'">
...
// Enhanced trust badges with updated target market text
const trustBadges = ref<TrustBadge[]>([
  ...
  {
    id: 4,
    text: "Trusted by hotels, restaurants & diaspora",
    icon: Users
  },
  {
    id: 5,
