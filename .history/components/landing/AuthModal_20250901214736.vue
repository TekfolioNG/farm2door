        ...
        <div v-if="show"
            ...
            <div
                ...
                <div class="md:flex md:min-h-0">
                    ...
                    <div
                        class="hidden md:flex md:flex-col md:justify-center md:items-center md:w-1/3 md:bg-gradient-to-br md:from-[#7ba54a] md:to-[#6a9342] md:p-8 md:text-center">
                        <div class="flex flex-col items-center">
                            <img src="/assets/img/Farm2Door Logo-trans.png" alt="Farm2Door"
                                class="h-16 w-auto mb-4 filter brightness-0 invert" />
                            <h2 class="text-white text-xl font-semibold mb-2">Welcome to Farm2Door</h2>
                            <p class="text-white/90 text-sm">Fresh produce directly from farms to your door</p>
                        </div>
                    </div>
                    ...
                    <div class="md:w-2/3 md:flex md:flex-col">
                        ...
                        <div
                            class="flex flex-col items-center justify-start pt-4 pb-3 px-6 md:hidden bg-gradient-to-br from-[#7ba54a] to-[#6a9342]">
                            <img src="/assets/img/Farm2Door Logo-trans.png" alt="Farm2Door"
