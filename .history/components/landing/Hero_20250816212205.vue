          ...
          <div class="order-1 lg:order-2">
            <div class="relative">
              ...
              <div v-if="floatingProduct1"
                ...
                style="transition-delay: 800ms" @click="setFeaturedProduct(floatingProduct1)">
                <img :src="floatingProduct1.image" :alt="floatingProduct1.alt"
                  class="w-full h-full object-cover transition-all duration-1000 hover:scale-105" />
                <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
              </div>

              <!-- Floating Product Image 2 - Float Animation -->
              <div v-if="floatingProduct2"
                ...
                :class="isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
                style="transition-delay: 1000ms" @click="setFeaturedProduct(floatingProduct2)">
                <img :src="floatingProduct2.image" :alt="floatingProduct2.alt"
                  class="w-full h-full object-cover transition-all duration-1000 hover:scale-105" />
                <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
              </div>

              <!-- Floating Product Image 3 - Subtle Scale Animation -->
              <div v-if="floatingProduct3"
                ...
                :class="isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
                style="transition-delay: 1200ms" @click="setFeaturedProduct(floatingProduct3)">
                <img :src="floatingProduct3.image" :alt="floatingProduct3.alt"
                  class="w-full h-full object-cover transition-all duration-1000 hover:scale-105" />
                <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
              </div>
...
// Individual floating products for better type safety
const floatingProduct1 = computed(() => {
  if (products.value.length > 1) return products.value[1]
  return null
})

const floatingProduct2 = computed(() => {
  if (products.value.length > 2) return products.value[2]
  return null
})

const floatingProduct3 = computed(() => {
  if (products.value.length > 3) return products.value[3]
  return null
})
