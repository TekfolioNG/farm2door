<template>
    <div>
        ...
        <div v-if="showAuthModal"
            ...
            <!-- Modal Container -->
            <div
                class="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 scale-100 opacity-100">
                <!-- Close Button -->
...
// Emits
const emit = defineEmits(['close', 'login', 'signup', 'social-login'])
