          ...
          <div class="overflow-hidden">
            <div class="animate-scroll-categories flex whitespace-nowrap py-3">
              <span v-for="(category, index) in duplicatedCategories" :key="`${category}-${index}`"
                class="inline-block font-sans font-medium text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 px-8 sm:px-12">
                {{ category }}
              </span>
            </div>
          </div>
...
.animate-scroll-categories {
  animation: scroll-categories 12s linear infinite;
}
