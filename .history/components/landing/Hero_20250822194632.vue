    ...
    <div class="relative z-10 w-full min-h-screen flex items-center px-4 sm:px-6 lg:px-12 py-16 pt-24">
      <div class="w-full max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
          ...
          <!-- Left Column - Content -->
          <div class="order-2 lg:order-1 space-y-6 mt-8 lg:mt-16">
            <!-- Main Headline -->
        ...
        <div class="w-full flex justify-center mt-6 lg:mt-8 transition-all duration-1000 transform delay-1000"
...
import { Award, Clock, Globe, Leaf, Users, Utensils } from 'lucide-vue-next'
...
const trustBadges = ref<TrustBadge[]>([
  ...
  {
    id: 4,
    text: "Trusted by 10,000+ families & premium restaurants",
    icon: Users
  },
  {
    id: 5,
  ...
  {
    id: 6,
    text: "Serving Nigerian diaspora worldwide",
    icon: Globe
  }
])
