<template>
  <section
    class="relative w-full min-h-screen overflow-hidden bg-white dark:bg-[#022414] transition-colors duration-500">
...
const enterFarmMarket = () => {
  // Open the auth modal instead of navigating directly
  openAuthModal()
}
