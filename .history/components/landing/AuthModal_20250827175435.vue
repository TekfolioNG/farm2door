<template>
    <div>
        ...
        <div v-if="showAuthModal"
            ...
            <!-- Modal Container with responsive margins and width -->
            <div
                class="relative w-full max-w-md mx-4 bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 scale-100 opacity-100 my-8 md:my-12 lg:my-16">
                <!-- Close Button -->
                ...
                <!-- Logo with reduced bottom padding on desktop -->
                <div class="flex justify-center pt-6 px-6 md:pt-6 md:px-8 lg:pt-6">
                    <img src="/assets/img/Farm2Door Logo-trans.png" alt="Farm2Door" class="h-12 md:h-14 w-auto"
                        :class="isDarkMode ? 'filter invert brightness-0 contrast-100' : ''" />
                </div>

                <!-- Tabs -->
                <div class="flex border-b border-gray-200 dark:border-gray-700 mt-4 md:mt-5">
                    <button @click="activeTab = 'login'"
                        class="flex-1 py-3 md:py-3 text-center font-medium transition-colors" :class="activeTab === 'login'
                            ? 'text-[#7ba54a] border-b-2 border-[#7ba54a]'
                            : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'">
                        Login
                    </button>
                    <button @click="activeTab = 'signup'"
                        class="flex-1 py-3 md:py-3 text-center font-medium transition-colors" :class="activeTab === 'signup'
                            ? 'text-[#7ba54a] border-b-2 border-[#7ba54a]'
                            : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'">
                        Sign Up
                    </button>
                ...
                <div class="px-6 py-4 md:px-8 md:py-5">
                    ...
                    <div class="relative flex items-center my-4 md:my-5">
...
/* Make modal slightly wider on desktop */
