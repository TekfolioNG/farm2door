            ...
            <div
                ...
                <div class="md:flex md:min-h-0">
                    ...
                    <div class="md:w-2/3 md:flex md:flex-col">
                        ...
                        <div class="flex justify-center pt-6 px-6 md:hidden">
                                ...
                                <form v-if="activeTab === 'login'" @submit.prevent="handleLogin"
                                    ...
                                    <div>
                                        ...
                                        <input id="login-email" v-model="loginForm.email" type="email" required
                                            class="w-full px-3 py-2 md:px-4 md:py-2.5 text-sm md:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#7ba54a] focus:border-transparent dark:bg-gray-700 dark:text-white transition-colors"
                                    ...
                                    <button type="submit"
                                        class="w-full py-2 md:py-3 px-4 bg-[#7ba54a] hover:bg-[#6a9342] text-white text-sm md:text-base font-medium rounded-lg transition-colors duration-200">
                                        Log In
                                    </button>
                                </form>
