...
const products = ref<Product[]>([
  ...
  },
  {
    ...
    category: "Heritage Proteins",
    image: "/farm2door-smokedfish.png",
...
const featuredProduct = computed(() => {
  return products.value[currentFeaturedIndex.value] || {
    id: 0,
