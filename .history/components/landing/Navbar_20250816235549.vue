      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex-shrink-0">
            <img src="/assets/img/Farm2Door Logo-trans.png" alt="Farm2Door" class="h-10 w-auto" />
          </div>
...
import { Moon, ShieldCheck, Sun, Truck, User, UserPlus, Utensils } from 'lucide-vue-next'
