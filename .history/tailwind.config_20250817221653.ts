...
export default {
  ...
  corePlugins: {
    preflight: false, // Disable TailwindCSS reset to preserve existing styles
  },
  theme: {
    extend: {
      fontFamily: {
        ...
        hero: ["Montserrat", "ui-sans-serif", "system-ui", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "Noto Sans", "sans-serif"],
      },
      colors: {
        primary: {
          50: '#E6EDF5',
